...
public class ItemStreamControllerTest {
  ...
  @Autowired
  public ItemStreamControllerTest(WebTestClient webTestClient, ItemCappedReactiveRepository items, ReactiveMongoOperations mongoOperations) {
  ...
  public void streamAll() {
    final Flux<ItemCapped> itemCapped = webTestClient.get().uri("/stream/items")
        .exchange()
        .expectStatus().isOk()
